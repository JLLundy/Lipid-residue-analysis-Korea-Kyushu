...
setwd("/Users/olcraig/Documents/GitHub/KoreavsKyushu")
...
discr <- load_discr_data(filename="/Users/olcraig/Documents/GitHub/KoreavsKyushu/Discr.csv", mix)

```
```{r, eval=FALSE}
# Make an isospace plot
plot <- plot_data(filename="isospace_plot", mix,source,discr)
plot
```
```{r}
