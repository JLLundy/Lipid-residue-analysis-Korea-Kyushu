...
Conc_sum <- Conc_ref %>% group_by(Category) %>% summarise (Concd13C16 = mean(Ab_Percent_C16), SDC16 = sd(Ab_Percent_C16), Concd13C18 = mean(Ab_Percent_C18), SDC18 = sd(Ab_Percent_C18), n_conc = n())
Iso_sum
Conc_sum
```
...
annotate("text", label = "C4/millet", x = -20, y = -17, size = 3, colour = "black")+ 
  ...
  annotate("text", label = "Rice", x = -35, y = -34, size = 3, colour = "black")+   
  coord_fixed(ratio = 1)+
