...
load(here('arrivalestimates','millets_run.RData'))
...
save(rhats.millets,ess.millets,agreement.millets,post.millets,file=here('arrivalestimates','milletsarrival_res.RData'))
